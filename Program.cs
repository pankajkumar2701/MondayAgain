...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "MondayAgain", Version = "v1" });
...
builder.Services.AddTransient<MondayAgainContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "MondayAgain API v1");
